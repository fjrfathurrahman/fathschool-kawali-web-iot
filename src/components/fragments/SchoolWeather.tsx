    ...
    <>
      <Card classNames={{ base: "shadow-md" }}>
        <CardHeader className="flex flex-col items-start gap-4">
          ...
          {/* Suhu Saat Ini */}
          <div className="flex items-center gap-4 p-2 rounded-xl bg-gradient-to-r from-orange-200 to-orange-100 dark:from-orange-900/90 dark:to-orange-800/15 text-orange-500 w-full">
